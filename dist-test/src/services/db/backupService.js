...
import { googleSheetsService } from '../googleSheets/googleSheetsService.js';
export class BackupService {
     ...
     */
    async exportData() {
        const [categories, cards, visualScenes, hotspots, therapyDecks, therapyCards, settingsRecord, mediaBlobs,] = await Promise.all([
     ...
     */
    async parseAndImportCsv(csvText, targetCategoryId) {
