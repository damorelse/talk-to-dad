...
export const TodayOrientationView = () => {
    ...
    return (_jsxs("div", { className: "w-full h-full flex flex-col gap-3 overflow-y-auto p-1 select-none scrollbar-thin", children: [_jsxs("div", { className: "w-full bg-transparent px-1.5 py-1 flex items-center justify-between gap-3 min-w-0 flex-wrap sm:flex-nowrap", children: [_jsxs("div", { className: "flex items-center gap-3.5 min-w-0", children: [_jsx("span", { className: "text-3xl sm:text-4xl shrink-0 drop-shadow", children: greeting.icon }), _jsxs("div", { className: "flex items-baseline gap-2.5 min-w-0 flex-wrap", children: [_jsx("h1", { className: "text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight truncate", children: greeting.en }), _jsx("span", { className: "text-base sm:text-lg md:text-xl font-extrabold text-indigo-300", children: greeting.zh })] })] }), _jsxs("div", { className: "flex items-center gap-2.5 shrink-0", children: [_jsxs(DebouncedTouchable, { onPress: handleSpeakAll, minTouchSize: "lg", className: `
            ...
            `, "aria-label": "Speak all orientation information aloud", children: [_jsx("div", { className: "p-1.5 bg-white/15 rounded-xl flex items-center justify-center shrink-0", children: _jsx(Volume2, { className: "w-6 h-6 stroke-[2.5] text-white" }) }), _jsxs("div", { className: "flex flex-col items-start leading-tight", children: [_jsx("span", { className: "text-base sm:text-lg font-black tracking-wide text-white", children: "Speak All" }), _jsx("span", { className: "text-xs font-bold text-indigo-200", children: "\u6717\u8B80\u5168\u90E8" })] })] }), isSpeaking && (_jsxs("button", { type: "button", onClick: stopAll, className: "min-h-[52px] sm:min-h-[56px] px-3.5 sm:px-4 py-2 bg-rose-600 hover:bg-rose-500 active:bg-rose-700 text-white rounded-2xl text-xs sm:text-sm font-black shadow-lg border border-rose-400 flex items-center gap-2 transition-all cursor-pointer hover:scale-105", "aria-label": "Stop speaking", children: [_jsx(VolumeX, { className: "w-5 h-5" }), _jsxs("div", { className: "flex flex-col items-start leading-tight", children: [_jsx("span", { children: "Stop" }), _jsx("span", { className: "text-[10px] text-rose-200 font-bold", children: "\u505C\u6B62" })] })] }))] })] }), _jsxs("div", { className: "w-full flex-1 grid grid-cols-1 lg:grid-cols-2 gap-3.5 min-h-0", children: [_jsxs("div", { className: "flex flex-col gap-3.5", children: [_jsxs(DebouncedTouchable, { onPress: handleSpeakTime, minTouchSize: "lg", className: `
