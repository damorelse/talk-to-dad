...
import { Volume2, Calendar, Clock, RefreshCw, Sparkles, Compass, VolumeX, } from 'lucide-react';
    ...
    return (_jsxs("div", { className: "w-full h-full flex flex-col gap-3 overflow-y-auto p-1 select-none scrollbar-thin", children: [_jsxs("div", { className: "w-full bg-gradient-to-r from-slate-900 via-indigo-950/60 to-slate-900 border-2 border-indigo-500/40 rounded-3xl p-4 sm:p-5 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-3.5 sm:gap-4 text-center sm:text-left min-w-0", children: [_jsx("div", { className: "w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-indigo-600/30 border-2 border-indigo-400/60 flex items-center justify-center text-indigo-300 shrink-0 text-3xl sm:text-4xl shadow-lg shadow-indigo-950/80", children: greeting.icon }), _jsxs("div", { className: "flex flex-col min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2 justify-center sm:justify-start flex-wrap", children: [_jsx("h1", { className: "text-xl sm:text-2xl font-black text-white tracking-tight", children: greeting.en }), _jsx("span", { className: "text-sm sm:text-base font-extrabold text-indigo-300 bg-indigo-500/20 border border-indigo-400/40 px-2.5 py-0.5 rounded-full", children: greeting.zh })] }), _jsxs("p", { className: "text-xs sm:text-sm font-bold text-slate-300 mt-1 truncate", children: ["Today is ", currentWeekday.name, ", ", monthName, " ", dayNum, " \u00B7 \u4ECA\u5929\u662F ", year, " \u5E74 ", currentDate.getMonth() + 1, " \u6708 ", dayNum, " \u65E5 (", currentWeekday.nameZh, ")"] })] })] }), _jsxs("div", { className: "flex items-center gap-2.5 w-full sm:w-auto shrink-0", children: [_jsxs(DebouncedTouchable, { onPress: handleSpeakAll, minTouchSize: "lg", className: `
            ...
            `, children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2.5", children: [_jsx("div", { className: "w-9 h-9 rounded-xl bg-amber-500/20 border border-amber-400 flex items-center justify-center text-amber-300 shadow-inner", children: _jsx(Calendar, { className: "w-5 h-5" }) }), _jsxs("div", { children: [_jsx("span", { className: "text-xs font-extrabold text-slate-400 uppercase tracking-wider block", children: "Weekday \u00B7 \u661F\u671F" }), _jsxs("span", { className: "text-lg sm:text-xl font-black text-white", children: [currentWeekday.name, " (", currentWeekday.nameZh, ")"] })] })] }), _jsxs(DebouncedTouchable, { onPress: () => handleSpeakWeekday(), minTouchSize: "md", className: `
              ...
              ${isDateActive
                                    ...
                                    : 'border-slate-700 hover:border-slate-600'}
            `, children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2.5", children: [_jsx("div", { className: "w-9 h-9 rounded-xl bg-blue-500/20 border border-blue-400 flex items-center justify-center text-blue-300 shadow-inner", children: _jsx(Sparkles, { className: "w-5 h-5" }) }), _jsxs("div", { children: [_jsx("span", { className: "text-xs font-extrabold text-slate-400 uppercase tracking-wider block", children: "Date \u00B7 \u65E5\u66C6\u65E5\u671F" }), _jsx("span", { className: "text-xs text-slate-400 font-medium", children: "Month, Day & Year Calendar" })] })] }), _jsxs(DebouncedTouchable, { onPress: handleSpeakDate, minTouchSize: "md", className: `
                  border px-3.5 py-2 rounded-xl text-xs font-black flex items-center gap-1.5 shadow transition-colors
                  ${isDateActive
                                                    ? 'bg-blue-500 text-white border-blue-300 ring-2 ring-white'
                                                    : 'bg-slate-800 hover:bg-slate-700 text-blue-300 border-blue-500/40'}
                `, "aria-label": "Speak current date", children: [_jsx(Volume2, { className: "w-4 h-4" }), _jsx("span", { children: "Speak \u65E5\u671F" })] })] }), _jsxs(DebouncedTouchable, { onPress: handleSpeakDate, minTouchSize: "lg", className: "w-full bg-slate-950/90 border border-slate-800 rounded-2xl p-4 flex items-center justify-between shadow-inner hover:border-blue-500/50 transition-colors cursor-pointer group", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsxs("div", { className: "w-16 h-16 sm:w-18 sm:h-18 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white flex flex-col items-center justify-center shadow-lg border border-blue-400/40 shrink-0", children: [_jsx("span", { className: "text-[11px] sm:text-xs font-black uppercase tracking-wider text-blue-200", children: monthName.slice(0, 3) }), _jsx("span", { className: "text-2xl sm:text-3xl font-black leading-none my-0.5", children: dayNum }), _jsx("span", { className: "text-[11px] font-bold text-blue-200 leading-none", children: year })] }), _jsxs("div", { className: "flex flex-col text-left", children: [_jsxs("span", { className: "text-lg sm:text-2xl font-black text-white group-hover:text-blue-300 transition-colors", children: [monthName, " ", dayNum, ", ", year] }), _jsxs("span", { className: "text-sm sm:text-base font-extrabold text-slate-300 mt-0.5", children: [year, " \u5E74 ", currentDate.getMonth() + 1, " \u6708 ", dayNum, " \u65E5"] })] })] }), _jsx("div", { className: "shrink-0 hidden sm:flex items-center text-xs font-black text-blue-400 bg-blue-500/10 px-3 py-1.5 rounded-xl border border-blue-500/30", children: "Tap to Hear" })] })] })] }), _jsxs("div", { className: "flex flex-col gap-3", children: [_jsxs("div", { className: `
              bg-slate-900 border-2 rounded-3xl p-4 flex flex-col justify-between shadow-xl gap-3 transition-all duration-200
              ${isTimeActive
            ...
            `, children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2.5", children: [_jsx("div", { className: "w-9 h-9 rounded-xl bg-emerald-500/20 border border-emerald-400 flex items-center justify-center text-emerald-300 shadow-inner", children: _jsx(Clock, { className: "w-5 h-5" }) }), _jsxs("div", { children: [_jsx("span", { className: "text-xs font-extrabold text-slate-400 uppercase tracking-wider block", children: "Live Time \u00B7 \u73FE\u5728\u6642\u9593" }), _jsx("span", { className: "text-xs text-slate-400 font-medium", children: "Calm 12-Hour Synchronized Clock" })] })] }), _jsxs(DebouncedTouchable, { onPress: handleSpeakTime, minTouchSize: "md", className: `
                ...
                `, "aria-label": "Speak current time", children: [_jsx(Volume2, { className: "w-4 h-4" }), _jsx("span", { children: "Speak \u6642\u9593" })] })] }), _jsxs(DebouncedTouchable, { onPress: handleSpeakTime, minTouchSize: "lg", className: "w-full bg-slate-950/90 border border-slate-800 rounded-2xl p-4 flex items-center justify-between shadow-inner hover:border-emerald-500/50 transition-colors cursor-pointer group", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsxs("div", { className: "w-16 h-16 sm:w-18 sm:h-18 rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-700 text-white flex flex-col items-center justify-center shadow-lg border border-emerald-400/40 shrink-0 text-3xl", children: [_jsx("span", { children: dayPeriod.icon }), _jsx("span", { className: "text-[10px] font-black uppercase text-emerald-100 mt-0.5 tracking-wider", children: dayPeriod.en })] }), _jsxs("div", { className: "flex flex-col text-left", children: [_jsxs("div", { className: "flex items-baseline gap-2", children: [_jsxs("span", { className: "text-3xl sm:text-4xl font-black font-mono tracking-tight text-white group-hover:text-emerald-300 transition-colors", children: [displayHours12, ":", minStr] }), _jsx("span", { className: "text-xs sm:text-sm font-black text-emerald-300 bg-emerald-500/20 border border-emerald-500/40 px-2 py-0.5 rounded-lg ml-1", children: ampm })] }), _jsxs("span", { className: "text-sm sm:text-base font-extrabold text-slate-300 mt-0.5", children: [dayPeriod.zh, " ", displayHours12, " \u9EDE ", minutes, " \u5206"] })] })] }), _jsx("div", { className: "shrink-0 hidden sm:flex items-center text-xs font-black text-emerald-400 bg-emerald-500/10 px-3 py-1.5 rounded-xl border border-emerald-500/30", children: "Tap to Hear" })] })] }), _jsxs("div", { className: `
              bg-slate-900 border-2 rounded-3xl p-4 flex flex-col justify-between shadow-xl gap-3 transition-all duration-200
              ${isLocationActive
            ...
            `, children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2.5 min-w-0", children: [_jsx("div", { className: "w-9 h-9 rounded-xl bg-purple-500/20 border border-purple-400 flex items-center justify-center text-purple-300 shadow-inner shrink-0", children: _jsx(Compass, { className: "w-5 h-5" }) }), _jsxs("div", { className: "min-w-0", children: [_jsx("span", { className: "text-xs font-extrabold text-slate-400 uppercase tracking-wider block", children: "World Location \u00B7 \u6240\u5728\u4F4D\u7F6E" }), _jsxs("span", { className: "text-xs font-black text-white truncate block", children: [location.city, location.state ? `, ${location.state}` : '', ", ", location.country] })] })] }), _jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [_jsx("button", { type: "button", onClick: refreshLocation, disabled: isLocating, className: "p-2 bg-slate-800 hover:bg-slate-700 active:bg-slate-600 text-slate-300 border border-slate-700 rounded-xl transition-colors disabled:opacity-50", "aria-label": "Refresh location via GPS", title: "Refresh location", children: _jsx(RefreshCw, { className: `w-3.5 h-3.5 ${isLocating ? 'animate-spin text-purple-400' : ''}` }) }), _jsxs(DebouncedTouchable, { onPress: handleSpeakLocation, minTouchSize: "md", className: `
                  ...
                  `, "aria-label": "Speak current location", children: [_jsx(Volume2, { className: "w-4 h-4" }), _jsx("span", { children: "Speak \u4F4D\u7F6E" })] })] })] }), _jsx(WorldMapSvg, { location: location, onSelectLocation: handleSpeakLocation, isSpeakingLocation: isLocationActive })] })] })] }), _jsxs("div", { className: "w-full bg-slate-950 border border-slate-800 rounded-2xl p-3.5 sm:p-4 flex flex-col gap-1.5 shadow-inner mt-1", children: [_jsxs("div", { className: "flex items-center justify-between text-xs font-extrabold text-slate-400", children: [_jsx("span", { className: "flex items-center gap-1.5 text-slate-300", children: _jsx("span", { children: "\uD83D\uDCAC Spoken Composite Statement \u00B7 \u6717\u8B80\u8A9E\u53E5\u9810\u89BD" }) }), _jsxs("button", { type: "button", onClick: handleSpeakAll, className: "text-indigo-400 hover:text-indigo-300 flex items-center gap-1 font-black text-xs", children: [_jsx(Volume2, { className: "w-3.5 h-3.5" }), _jsx("span", { children: "Play Aloud \u64AD\u653E" })] })] }), _jsxs("p", { className: "text-sm sm:text-base font-bold text-amber-300 tracking-wide leading-snug", children: ["\"", fullSpeech.en, "\""] }), _jsxs("p", { className: "text-sm sm:text-base font-bold text-white tracking-wide leading-snug pt-1 border-t border-slate-800/80", children: ["\u300C", fullSpeech.zh, "\u300D"] })] })] }));
};
