...
export const TodayOrientationView = () => {
    ...
    return (_jsxs("div", { className: "w-full h-full flex flex-col gap-3 overflow-y-auto p-1 select-none scrollbar-thin", children: [_jsxs("div", { className: "w-full bg-transparent px-1.5 py-0.5 flex items-center justify-start gap-3.5 sm:gap-4 min-w-0 flex-wrap sm:flex-nowrap", children: [_jsxs("div", { className: "flex items-center gap-2.5 shrink-0 min-w-0", children: [_jsx("span", { className: "text-2xl sm:text-3xl shrink-0 drop-shadow", children: greeting.icon }), _jsxs("div", { className: "flex items-baseline gap-2 min-w-0", children: [_jsx("h1", { className: "text-lg sm:text-xl md:text-2xl font-black text-white tracking-tight truncate", children: greeting.en }), _jsx("span", { className: "text-sm sm:text-base md:text-lg font-extrabold text-indigo-300", children: greeting.zh })] })] }), _jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [_jsxs(DebouncedTouchable, { onPress: handleSpeakAll, minTouchSize: "md", className: `
            ...
            `, "aria-label": "Speak all orientation information aloud", children: [_jsx(Volume2, { className: "w-4 h-4 sm:w-4.5 sm:h-4.5 stroke-[2.5] text-white" }), _jsx("span", { className: "font-black tracking-wide text-white whitespace-nowrap", children: "Speak All" })] }), isSpeaking && (_jsxs("button", { type: "button", onClick: stopAll, className: "h-10 sm:h-11 px-3.5 sm:px-4 bg-rose-600 hover:bg-rose-500 active:bg-rose-700 text-white rounded-xl text-xs sm:text-sm font-black shadow-lg border border-rose-400 flex items-center gap-1.5 transition-all cursor-pointer hover:scale-105", "aria-label": "Stop speaking", children: [_jsx(VolumeX, { className: "w-4 h-4" }), _jsx("span", { className: "whitespace-nowrap", children: "Stop" })] }))] })] }), _jsxs("div", { className: "w-full flex-1 grid grid-cols-1 lg:grid-cols-2 gap-2.5 sm:gap-3 min-h-0", children: [_jsxs("div", { className: "flex flex-col gap-2.5 sm:gap-3 h-full", children: [_jsxs(DebouncedTouchable, { onPress: handleSpeakTime, minTouchSize: "lg", className: `
