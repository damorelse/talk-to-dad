    ...
    return (_jsxs("div", { className: "w-full h-full flex flex-col gap-3 overflow-y-auto p-1 select-none scrollbar-thin", children: [_jsxs("div", { className: "w-full bg-slate-900/90 border border-slate-800 rounded-2xl px-5 py-3.5 shadow-lg flex items-center justify-between gap-3 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-3.5 min-w-0", children: [_jsx("span", { className: "text-3xl sm:text-4xl shrink-0 drop-shadow", children: greeting.icon }), _jsxs("div", { className: "flex items-baseline gap-2.5 min-w-0 flex-wrap", children: [_jsx("h1", { className: "text-xl sm:text-2xl font-black text-white tracking-tight truncate", children: greeting.en }), _jsx("span", { className: "text-base sm:text-lg font-extrabold text-indigo-300", children: greeting.zh })] })] }), _jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [_jsxs(DebouncedTouchable, { onPress: handleSpeakAll, minTouchSize: "lg", className: `
          ...
          `, children: [_jsxs("div", { className: "flex items-center justify-between w-full", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Calendar, { className: "w-5 h-5 text-amber-400" }), _jsx("span", { className: "text-xs sm:text-sm font-bold text-slate-400 uppercase tracking-wider", children: "Weekday \u00B7 \u661F\u671F" })] }), _jsxs("button", { type: "button", onClick: () => handleSpeakWeekday(), className: "text-sm sm:text-base font-black text-amber-300 hover:text-amber-200 flex items-center gap-1.5 transition-colors cursor-pointer", children: [_jsxs("span", { children: [currentWeekday.name, " (", currentWeekday.nameZh, ")"] }), _jsx(Volume2, { className: "w-4 h-4 text-amber-400" })] })] }), _jsx("div", { className: "my-auto py-1", children: _jsx(WeekdayBar, { currentDate: currentDate, onSelectDay: (day, isToday) => handleSpeakWeekday(day, isToday), activeGlowDayIndex: isWeekdayActive ? currentWeekday.index : null }) })] }), _jsxs("div", { className: `
            ...
            ${isLocationActive
                            ...
                            : 'border-slate-800 hover:border-slate-700'}
          `, children: [_jsxs("div", { className: "flex items-center justify-between w-full", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Compass, { className: "w-5 h-5 text-purple-400" }), _jsx("span", { className: "text-xs sm:text-sm font-bold text-slate-400 uppercase tracking-wider", children: "Location \u00B7 \u6240\u5728\u4F4D\u7F6E" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("button", { type: "button", onClick: refreshLocation, disabled: isLocating, className: "p-1 text-slate-400 hover:text-purple-300 transition-colors disabled:opacity-50 cursor-pointer", "aria-label": "Refresh location", title: "Refresh GPS", children: _jsx(RefreshCw, { className: `w-4 h-4 ${isLocating ? 'animate-spin text-purple-400' : ''}` }) }), _jsx("button", { type: "button", onClick: handleSpeakLocation, className: "text-purple-400 hover:text-white transition-colors p-1 cursor-pointer", "aria-label": "Speak location", children: _jsx(Volume2, { className: "w-5 h-5" }) })] })] }), _jsx("div", { className: "flex-1 flex flex-col justify-center min-h-[140px]", children: _jsx(WorldMapSvg, { location: location, onSelectLocation: handleSpeakLocation, isSpeakingLocation: isLocationActive }) })] })] })] }));
};
